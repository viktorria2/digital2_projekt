...
/** @brief Set overflow 4ms, prescaler 001 --> 1 */
#define TIM0_ovf_16us() TCCR0B &= ~((1<<CS12) | (1<<CS11)); TCCR0B |= (1<<CS10);

/** @brief Set overflow 33ms, prescaler 010 --> 8 */
#define TIM0_ovf_128us() TCCR0B &= ~((1<<CS12) | (1<<CS10)); TCCR0B |= (1<<CS11);

/** @brief Set overflow 262ms, prescaler 011 --> 64 */
#define TIM0_ovf_1ms() TCCR0B &= ~(1<<CS12); TCCR0B |= (1<<CS11) | (1<<CS10);

/** @brief Set overflow 1s, prescaler 100 --> 256 */
#define TIM0_ovf_4ms() TCCR0B &= ~((1<<CS11) | (1<<CS10)); TCCR0B |= (1<<CS12);

/** @brief Set overflow 4s, prescaler // 101 --> 1024 */
#define TIM0_ovf_16ms() TCCR0B &= ~(1<<CS11); TCCR0B |= (1<<CS12) | (1<<CS10);
...
/** @brief Set overflow 4ms, prescaler 001 --> 1 */
#define TIM2_ovf_16us() TCCR2B &= ~((1<<CS12) | (1<<CS11)); TCCR2B |= (1<<CS10);

/** @brief Set overflow 33ms, prescaler 010 --> 8 */
#define TIM2_ovf_128us() TCCR2B &= ~((1<<CS12) | (1<<CS10)); TCCR2B |= (1<<CS11);

/** @brief Set overflow 262ms, prescaler 011 --> 64 */
#define TIM2_ovf_1ms() TCCR2B &= ~(1<<CS12); TCCR2B |= (1<<CS11) | (1<<CS10);

/** @brief Set overflow 1s, prescaler 100 --> 256 */
#define TIM2_ovf_4ms() TCCR2B &= ~((1<<CS11) | (1<<CS10)); TCCR2B |= (1<<CS12);
